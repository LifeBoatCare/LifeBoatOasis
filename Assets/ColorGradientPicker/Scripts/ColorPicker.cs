...
public class ColorPicker : MonoBehaviour
{
    ...
    public CharacterCustomizer CharCustomiser;
    public string initialColorString;
    ...
    private void Awake()
    {
        instance = this;
        Color color;
        ColorUtility.TryParseHtmlString("#" + PlayerPrefs.GetString(initialColorString,"FF0000"), out color);

        Create(color, null, null, null, false);
    ...
    private void RecalculateMenu(bool recalculateHSV)
    {
        ...
        interact = true;
        if(initialColorString == "SkinColor")
            CharCustomiser.SetSkinColor();
        else if(initialColorString == "TopColor")
            CharCustomiser.SetTopColor();
        else if(initialColorString == "BottomColor")
            CharCustomiser.SetBottomColor();
    }
